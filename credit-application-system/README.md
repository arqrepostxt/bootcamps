...
# Melhorias no Projeto por Samuel Mendes

<ol>
  <li>Adicionado ao CustomerRepository findbyCpf e findbyEmail</li>
  <li>Adicionada anotação personalizada para validar se o e-mail ou cpf é único, se já cadastrado retornará uma resposta com mensagem. Uso abaixo: </li>
	```
...
```
  <li>Adicionado  teste para CustomerRepository`</li>
</ol> 
